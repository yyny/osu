                    ...
                    Items = new[]
                    {
                        ...
                        new MenuItem("Timing")
                        {
                            Items = new[]
                            {
                                ...
                                new EditorMenuItemSpacer(),
                                new EditorMenuItem("Resnap All Notes", null, MenuItemType.Destructive),
                                new EditorMenuItem("Move all notes in time...", null, MenuItemType.Destructive),
                                new EditorMenuItem("Recalculate Slider Lengths", null, MenuItemType.Destructive),
                                new EditorMenuItem("Delete All Timing Sections", null, MenuItemType.Destructive),
                                new EditorMenuItemSpacer(),
